...
%%% XXX TODO
\title{HexMage - Encounter Balancing in Hex Arena}

% Thesis title in English (exactly as in the formal assignment)
\def\ThesisTitle{HexMage - Encounter Balancing in Hex Arena}
...
\include{app-impl-analysis}
\include{app-file-formats}
\include{app-doc-user}
\include{app-doc-programmer}
