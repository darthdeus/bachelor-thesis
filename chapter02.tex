...
of actions per second on a consumer-grade PC \todo{graf?}. The state object is split into two parts,
...
This allowed us to make state copies very fast as well, running only at a few microseconds per copy \todo{graf?}.
